...
const Header: FC = () => (
  <header className="z-30 flex flex-col items-center justify-center justify-between gap-2 bg-teal-500 px-[10%] pb-2.5 pt-1.5 text-white shadow-md md:flex-row">
